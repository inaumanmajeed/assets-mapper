...
### Changed
- **Documentation**: Improved README with prominent config file usage guide
- **CLI Examples**: Better organized CLI usage examples (basic vs advanced)
- **Dependencies**: Updated minimatch to v9 for broader Node.js compatibility

### Fixed
- Package-lock.json regenerated for consistent CI builds
